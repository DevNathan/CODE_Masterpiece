...
S.Label = styled.label`
    ...
    & input {
        border: 1px solid ${({$err}) => ($err === "true" ? theme.PALLETE.error : "#aea8b2")};
        height: 48px;
        color: ${({theme}) => theme.textColor};
        font-size: 16px;
        box-shadow: 0 4px 8px 0 ${({theme}) => 
                theme.themeMode ? "rgb(150, 150, 150, 0.5)" : "rgb(28, 37, 44, 0.08)"};
